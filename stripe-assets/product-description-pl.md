...
**Cena: 699 zł jednorazowo. Bez ukrytych opłat, bez abonamentu.**

Brief: https://zaproszeniaonline.com/#kontakt
Demo: https://zaproszeniaonline.com/demo

---

## Statement descriptor (na wyciągu karty klienta)

`ZAPROSZENIA` (max 22 znaki, dozwolone)

Alternatywne (gdyby pierwsze nie przeszło Stripe validation):
- `ZAPROSZENIAONLINE`
- `ZAPROSZENIA SLUBNE`

## Metadata (key-value pairs w Stripe)
